...
{
    public class QuotationController : ApplicationBaseController
    {
        ...
        {
            return View(_unitOfWork.Quotes.GetAllCustomers().OrderByDescending(o => o.CreatedAt));
        }
        ...
        {
            var list = _unitOfWork.Quotes.GetAllApproved();
        ...
        public ActionResult Download(int? id)
        {
            ...
            if (id.HasValue)
            {
                ...
                InvoiceService.Invoice invoice = new InvoiceService.Invoice()
                {
                    ...
                    Status = "Due",
                    Notes = "Thank you for your business.",
                    Terms = "Sales Invoice generated by Abstergo (Pty) Ltd. This invoice is only valid for 7 days. VAT is included.",
                    Date = DateTime.Now,
                };
