...
$(document).ready(function () {
    $(function () {
        ...
        //Get the records that match the search box.
        ...
        $("#Search").autocomplete({
            source: function(request, response) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        response($.map(data,
                            function(item) {
                                return { label: item.name, value: item.sellingPrice };
                            }));
                    },
            ...
            //    var productItem = '<tr>  + <td>' + ui.item.label
            //        + '</td><td class="price">' + ui.item.value
            //        + '</td><td>'
            //        + '<input  class="quantity" type= "number" min= "1" step= "1" value= "1"  max="99" />'
            //        + '</td><td class="amount">'
            //        + ui.item.value
            //        + '</td><td><a data-itemId="'
            //        + 0
            //        + '" href="#" class="deleteItem"><i class="fa fa-trash"></i></a></td></tr>';
            //    //
