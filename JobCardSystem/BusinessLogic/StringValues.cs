    ...
    public struct StringValues : IList<string>, ICollection<string>, IEnumerable<string>, IEnumerable, IReadOnlyList<string>, IReadOnlyCollection<string>, IEquatable<StringValues>, IEquatable<string>, IEquatable<string[]>
    {
        ...
        private void CopyTo(string[] array, int arrayIndex)
        {
            ...
            else
            {
                ...
                if (array.Length - arrayIndex < 1)
                    throw new ArgumentException(string.Format("'{0}' is not long enough to copy all the items in the collection. Check '{1}' and '{2}' length.", (object)nameof(array), (object)nameof(arrayIndex), (object)nameof(array)));
        ...
        public override int GetHashCode()
        {
            ...
            for (int index = 0; index < this._values.Length; ++index)
                hashCodeCombiner.Add(this._values[index]);
